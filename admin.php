...
//            }
            ...
            if (isset($_POST["status"]) && $_POST["status"] == 'register_api') {
                ...
                if ($registerResult["status"] == "error") {
                    ...
                    <div class="updated"><p><strong>Manual activation available at <a href="https://api.idapi.ee/register_api?auth_key=<?php echo $_SESSION["auth_key"]; ?>">here</a></strong></p></div>    
                    <?php
                    return;
                }
