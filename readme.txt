...
3. Filters to customize login buttons look and feel are: "ee-id-card-login, ee-mobile-id-login, ee-web-eid-login, lv-id-card-login, lt-id-card-login, lt-mobile-id-login, pt-id-card-login, smart-id-login"
