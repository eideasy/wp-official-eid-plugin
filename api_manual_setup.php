...
<div class = "container">
    <div id = "loginBlock" class = "col-md-offset-3 col-md-6">
        ...
        <small>Credentials can be reviewed and generated manually at <a href="https://id.smartid.dev" target="_blank">https://id.smartid.ee</a>. Look for credentials to website <?php echo home_url(); ?></small>
        <br>    
        <?php
